...
function App() {
  ...
  return (
    < >
      <div className="bg-gradient-to-r from-purple-300 via-white to-purple-300 min-h-screen p-3">
      <h1 className='font-extrabold text-center text-3xl px-2'>&lt;iTask/&gt; </h1>
      <p className=' text-center font-bold text-sm'> Manage your tasks here!</p>
        
        <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-gradient-to-r from-purple-300 via-pink-100 to-purple-100 min-h-[80vh] md:w-[35%] border-2 border-purple-400">
